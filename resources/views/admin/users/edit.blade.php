...
<form method="POST" action="{{ url('/users/'.$user->id) }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="name" class="form-control" id="name" placeholder="{{__('Name')}}..." value="{{ $user->name }}" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="password" name="password" class="form-control" id="password" placeholder="{{__('Password')}}..." minlength="8">
    </div>
    <div class="form-group">
